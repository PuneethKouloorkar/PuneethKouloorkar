...
[![CV](https://img.shields.io/badge/-CV-blue)](https://drive.google.com/file/d/1vySyUQ_OS7A_mCXg5e_cVx6fiDPm7mfv/view?usp=sharing)
...
| [Molecular Dynamics of protein](https://github.com/PuneethKouloorkar/MD_openmm) | Python (NumPy and Matplotlib libraries) and Visual Molecular Dynamics | Common Nearest Neighbours clustering of dynamics of 6a5j protein |
| [Event Driven Pedestrian & Vehicle Detection](https://github.com/akshayjoshii/Event-Driven-Pedestrian-Vehicle-Detection) | Python, YOLO, OpenCV, NumPy, Docker, TQDM | Vehicle detectiob by YOLO |
